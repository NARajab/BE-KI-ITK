const copyrightSubmissionMail = ({ fullname, email, titleInvention }) => {
  return `
    <html>
        <head>
          <style>
        ...
        <body>
          <div class="email-container">
            <div class="email-header">
              <h2>Pengajuan Hak Cipta Baru</h2>
            </div>
            <div class="email-content">
              <p><strong>Pengguna:</strong> ${fullname} (${email})</p>
              <p><strong>Judul Ciptaan:</strong> ${titleInvention}</p>
              <p>Pengguna telah membuat pengajuan hak cipta baru dan perlu ditinjau oleh admin.</p>
              <p>Terima kasih,</p>
            </div>
